...
def load_data(db_path = '../data/Disaster_Response.db', table_name = "messages_tab"):
    '''
...
def main():
    ...
    if len(sys.argv) == 4:
        ...
        print("Loading data...")
        X,y = load_data(db_path=database_path,table_name=table_name)
        print("Data loaded!")
        print("------------")
        ...
        print("Please provide the filepaths of the database (first argument) "\
              "and the destination of the model export (second argument)!")
